					...
					if (ControlTurno % 2 == 0)
					{
						...
						if(keyPlayer[0] == '1'){//TIRAR EL DADO Y VALIDACIONES DE POSICION
							...
							{	
								...
								{	
									...
									{	
										...
										mvprintw(15,50,"Pagas la renta.");
										mvprintw(16,50,board.at(Espacio) -> getTitle().c_str());
							...
							if (Jugador1 -> validarProperties(board.at(Espacio) -> getTitle())) {
								...
								if (tryTemp -> getHouses() == 0)
								{
									...
									if (confirm[0] == 'y' || confirm[0] == 'Y')
									{
										...
										} else if (howmuch[0] == '5' && tryTemp -> getHouses() == 5)
										{
											...
											tryTemp -> setHotels(0);
											mvprintw(18,50,"Sold everything. \n");
										} else
										{
								...
								mvprintw(5,50,"Esta propiedad no te pertenece.");
							}
