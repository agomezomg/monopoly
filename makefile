Monopoly:	Table.o cards.o others.o freeSquare.o community.o chance.o tax.o jail.o go.o properties.o player.o railway.o services.o avenues.o Monopoly.o
	g++ Table.o cards.o others.o freeSquare.o community.o chance.o tax.o jail.o go.o properties.o player.o railway.o services.o avenues.o Monopoly.o -lncurses -o pruebame
